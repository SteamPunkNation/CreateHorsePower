package com.steampunknation.createhorsepower.client.utils;
...
public class LeadRendererHelper {
    ...
    public static void renderLeash(CreatureEntity entity, Vector3d sourcePos, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn) {
        ...
        double d3 = MathHelper.lerp(partialTicks, entity.xOld, entity.xo) + d1;
        double d4 = MathHelper.lerp(partialTicks, entity.yOld, entity.yo) + startPos.y;
        double d5 = MathHelper.lerp(partialTicks, entity.zOld, entity.zo) + d2;
